...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-gray-50 via-white to-gray-100 scroll-mt-24">
            ...
            return (
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm">
                <CardContent className="p-6 text-center">
                  <div className="w-16 h-16 mx-auto mb-4 bg-black rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          <CardContent className="p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-300 text-lg">Months to Transform</p>
              </div>
              <div>
                <h3 className="text-4xl md:text-5xl font-bold mb-2">1:1</h3>
                <p className="text-gray-300 text-lg">Mentorship Sessions</p>
              </div>
              <div>
                <h3 className="text-4xl md:text-5xl font-bold mb-2">100%</h3>
                <p className="text-gray-300 text-lg">Project Completion</p>
              </div>
            </div>
          </CardContent>
        </Card>
