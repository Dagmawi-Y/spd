        ...
        <div className="text-center space-y-8 md:space-y-12">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              ...
              <div className="hidden md:block absolute top-16 left-0 right-0 h-0.5 bg-gray-300 transform translate-y-1/2"></div>
                ...
                {steps.map((step, index) => (
                  <div key={step.number} className="relative">
                    ...
                    <div className="flex justify-center mb-6">
                      <div className="w-12 h-12 bg-black text-white rounded-full flex items-center justify-center text-lg font-bold relative z-10">
                        {step.number}
                      </div>
                    </div>
