    ...
    <section id="previous-cohorts" className="py-16 md:py-24 lg:py-32 bg-background scroll-mt-24" aria-labelledby="previous-cohorts-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <StaggerContainer
          ...
          className={`grid gap-8 mb-12 ${featuredProjects.length === 1 ? 'grid-cols-1 max-w-md mx-auto' : featuredProjects.length === 2 ? 'grid-cols-1 md:grid-cols-2 max-w-4xl mx-auto' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3'}`}
        >
              ...
              <Card className="max-w-2xl mx-auto">
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">Explore all projects from our previous cohorts and get inspired by what you could build.</p>
